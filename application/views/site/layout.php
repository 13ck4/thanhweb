...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-gb" lang="en-gb" dir="ltr">
    ...
    <body class="site com-sppagebuilder layout1 homepage view-page  no-layout no-task itemid-555 en-gb ltr  sticky-header layout-fluid off-canvas-menu-init">
		...
		<div class="phonering-alo-phone phonering-alo-green phonering-alo-show hidden-xs visible-sm visible-md visible-lg" id="phonering-alo-phoneIcon" style="display: block; position: fixed;left: 0; top:420px; z-index: 9">
