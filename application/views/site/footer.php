...
<section id="sp-block-bottom-2">
    <div class="container">
        <div class="row">
            <div id="sp-position4" class="col-sm-6 col-md-6">
                <div class="sp-column ">
                    <div class="sp-module ">
                        <div class="sp-module-content">
                            <div class="custom">
                                <div class="logo-bottom">
                                    <div class="img-logo">
                                        <img src="<?=public_url('site/images/logo.jpg')?>" alt="">
                                    </div>
                                    <div class="img-logo">
                                        Gửi trọn niềm tin trong thế giới của bạn -&nbsp;Thế giới thời trang cao cấp 
                                    </div>
                                    <div class="content">
                                        <ul>
            ...
            <div id="sp-footer1" class="col-sm-8 col-md-8">
                <div class="sp-column ">
                    <span class="sp-copyright">
                        © 2018 
                        <a href="<?php echo base_url() ?>">Nguyễn Ngọc Luật</a>. Bản quyền này thuộc về 
                        <a href="<?php echo base_url() ?>">Nguyễn Ngọc Luật</a>
                    </span>
                </div>
            </div>
                ...
                <div class="sp-column ">
                    <div class="sp-module ">
                        <div class="sp-module-content">
                            <div class="custom">
                                <div class="payments">
                                    <img src="<?php echo public_url('site/images/pay.png')?>" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
